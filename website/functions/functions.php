...
function post_getstring($data) {
  $x = PostToHost(OCP_SERVICE_HOST,"/",$data);
  if ($x==NULL) {
...
function sendRoutes($nr, $email, $pw) {
  ...
  $msg .= t("To offer or request a lift, log in via your computer or smart phone at https://web.opencarpool.org using with your email address $email and your temporary password '$pw'. You can also offer or request lifts via any cell phone or enter recurring lifts in your Outlook calendar.\n\n");
